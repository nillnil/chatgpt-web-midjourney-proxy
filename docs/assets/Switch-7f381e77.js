import{r as C,bf as lt,e as N,f as a,H as f,I as s,g as Me,bg as st,bh as dt,d as Ae,h as Pe,k as ve,i as Ee,l as p,t as Ne,j as je,a4 as De,bi as ct,n as Ve,p as ut,q as $e,s as d,V as ht,v as ft,bj as vt,x as bt,T as gt,bk as mt,bl as he,bm as fe,aq as Se,F as oe,bn as Fe,G as _e,bo as ze,bp as U,bq as wt,br as pt,bs as xt,bt as K,bu as Ce,bv as I}from"./index-9dea4b07.js";function Ie(t){return window.TouchEvent&&t instanceof window.TouchEvent}function He(){const t=C(new Map),l=V=>x=>{t.value.set(V,x)};return lt(()=>t.value.clear()),[t,l]}const yt=N([a("slider",`
 display: block;
